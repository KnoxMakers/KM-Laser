...
class Gcodetools(inkex.Effect):
	...
	def process_settings(self,):
		...
		_presets = {
			"wood-engrave": [5,400],
			"3mm-plywood-cut": [20,400],
			"6mm-plywood-cut": [34,400],
			"acrylic-engrave": [5,400],
			"3mm-plywood-cut": [20,400],
			"6mm-plywood-cut": [34,400],			
		}
		...
		if (pulserate * feedrate) > (400 * 34):
			self.error("That combination of Feed Rate and Pulse Rate will push the current too high for the laser.  Try lowering one or both of the values.")
			return False
...
#					poly.draw(color = "Violet",width=4)					
	...
	def __init__(self):
		...
		self.OptionParser.add_option("",   "--preset-settings",				action="store", type="string",		dest="preset",  default="custom", help="Preset Feedrate/Pulserate")
		self.OptionParser.add_option("",   "--feed-rate",					action="store", type="int",		dest="feedrate",  default="400", help="Feedrate for cutting")
		self.OptionParser.add_option("",   "--pulse-rate",					action="store", type="int",		dest="pulserate", default="34", help="Pulses per MM for laser")
